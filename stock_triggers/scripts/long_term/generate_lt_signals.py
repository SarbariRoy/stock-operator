"""Generate Pattern A breakout triggers from st_lt_prices_eod.csv.
...
Output is written to stock_triggers/data/lt_signals_pattern_a.csv.
"""
...
DEFAULT_SIGNALS = DATA_DIR / "lt_signals_pattern_a.csv"
DEFAULT_SELL_SIGNALS = DATA_DIR / "lt_sell_signals.csv"
...
def _build_score_components(
    *,
    ...
    lt_signals_pattern_a.csv carries the same signal_score semantics.
    """
